...
export default function App(): React.ReactNode {
  ...
  const frameProcessor = useSkiaFrameProcessor(
    (frame) => {
      ...
      let outputs1 = out[0] // This is an object with integer keys that aren't in order.
      const outputs = Array.prototype.slice.call(outputs1)  // This sorts the keys and makes it a normal array
      let boundingBoxes = [];
      let bestGuess = 0;
    ...
    for (let i = 0; i < gridCells; i++) {
        ...
        let maxClassIndex = classProbabilities.indexOf(Math.max(...classProbabilities)); // Index of the class probability corresponds to a specific index in the coco dataset
